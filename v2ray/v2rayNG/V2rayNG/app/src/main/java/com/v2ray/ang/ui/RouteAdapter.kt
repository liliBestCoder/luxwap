...
import com.v2ray.ang.databinding.ItemRouteBinding
...
class RouteAdapter(val activity: MainNewActivity) : RecyclerView.Adapter<RouteAdapter.BaseViewHolder>() {
    companion object {
    ...
    private var mActivity: MainNewActivity = activity
...
//            holder.itemMainBinding.tvType.text = profile.configType.name
            ...
            holder.itemMainBinding.radioButton.isChecked = guid == MmkvManager.getSelectServer()
            //layoutIndicator
...
//            }
            ...
            holder.itemMainBinding.radioButton.setOnClickListener {
                if (selectedPosition != position) {
                    selectedPosition = position
                }
                holder.itemMainBinding.infoContainer.performClick();
            }
        }
...
//    }
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): BaseViewHolder {
        return when (viewType) {
            VIEW_TYPE_ITEM ->
                MainViewHolder(ItemRouteBinding.inflate(LayoutInflater.from(parent.context), parent, false))
    ...
    class MainViewHolder(val itemMainBinding: ItemRouteBinding) :
...
//        holder.title.text = routes[position]
//        holder.radioButton.isChecked = position == selectedPosition
//
//        // 点整行也可以选中
...
//        return if (selectedPosition in routes.indices) routes[selectedPosition] else null
//    }
//}
