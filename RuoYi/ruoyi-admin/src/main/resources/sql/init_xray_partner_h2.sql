...
CREATE TABLE `xray_chain_proxy_node` (
  ...
  `region` varchar(64) DEFAULT '' COMMENT '出口省份/州',
  `city` varchar(64) DEFAULT '' COMMENT '出口城市',
...
INSERT INTO `xray_chain_proxy_node` (`id`, `node_key`, `user_id`, `source_type`, `protocol`, `host`, `port`, `username`, `password_cipher`, `remark`, `exit_ip`, `country_code`, `alive_status`, `latency_ms`, `refresh_url`, `last_check_time`, `sort_order`, `del_flag`, `create_by`, `create_time`, `update_time`) VALUES
(1, 'cp_seed00000000001', 1, 1, 'socks5', '45.74.31.23', 7782, '', '', 'GitHub开源S5跳板1', '45.74.31.23', 'US', 1, 120, '', CURRENT_TIMESTAMP, 0, '0', 'admin', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(2, 'cp_seed00000000002', 1, 1, 'socks5', '8.213.134.213', 443, '', '', 'GitHub开源S5跳板2', '8.213.134.213', 'SG', 1, 85, '', CURRENT_TIMESTAMP, 0, '0', 'admin', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
...
CREATE TABLE `xray_chain_proxy_config` (
  ...
  `active_node_key` varchar(64) DEFAULT '' COMMENT '当前激活的上游端点安全Key',
...
INSERT INTO `xray_chain_proxy_config` (`id`, `user_id`, `is_enabled`, `active_node_id`, `active_node_key`, `mode`, `create_time`, `update_time`) VALUES
(1, 1, 1, 1, 'cp_seed00000000001', 'fixed_exit', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
