...
//    @RequiresPermissions("system:luxwap-menu:list")
    @PostMapping("/luxwap-menu/list")
    @ResponseBody
    public List<SysMenu> luxwapMenuList()
    {
        SysUser user = getSysUser();
        List<SysMenu> menuList =  menuService.luxwapMenuList(user);
        return menuList;
    }
}