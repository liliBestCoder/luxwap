...
import com.ruoyi.framework.filter.ClientJwtFilter;
import com.ruoyi.framework.filter.ClientUserCleanupFilter;
...
public class ShiroConfig
{
    ...
    public ClientJwtFilter clientJwtFilter()
    {
        ClientJwtFilter clientJwtFilter = new ClientJwtFilter(xrayUserSessionMapper);
        return clientJwtFilter;
    }
    ...
    public ShiroFilterFactoryBean shiroFilterFactoryBean(SecurityManager securityManager)
    {
        ...
        filters.put("clientJwt", clientJwtFilter()); // 新增客户端的JWT过滤器
        shiroFilterFactoryBean.setFilters(filters);

        // 所有请求需要认证
        filterChainDefinitionMap.put("/api/client/login", "anon");
        filterChainDefinitionMap.put("/api/client/register", "anon");
        filterChainDefinitionMap.put("/api/client/send-code", "anon");
        filterChainDefinitionMap.put("/api/client/reset-password", "anon");
        filterChainDefinitionMap.put("/api/client/task/create", "anon");
        filterChainDefinitionMap.put("/api/client/task/result", "anon");
        filterChainDefinitionMap.put("/api/client/oauth/callback", "anon");
        filterChainDefinitionMap.put("/api/client/payment/notify/alipay", "anon");
        // 其他客户端接口需要客户端JWT
        filterChainDefinitionMap.put("/api/client/**", "clientJwt");
...
//        filterChainDefinitionMap.put("/**",  "anon");
    ...
    /**
     * 自定义 xray userId threadlocal处理过滤器
     */
    public ClientUserCleanupFilter clientUserCleanupFilter()
    {
        ClientUserCleanupFilter clientUserCleanupFilter = new ClientUserCleanupFilter();
        return clientUserCleanupFilter;
    }
