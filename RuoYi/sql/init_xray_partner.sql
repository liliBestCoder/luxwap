...
) ENGINE=InnoDB AUTO_INCREMENT=214 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='系统访问记录';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=179 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='操作日志记录';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `sys_user` VALUES (1,103,'admin','若依','00','ry@163.com','15888888888','1','','5c2c8ebc2b8a5b53fbde82902416455d','75b7a9','0','0','112.96.202.86','2026-09-09 09:33:12','2025-10-20 23:33:17','admin','2025-09-18 13:43:59','','2026-09-09 09:33:12','管理员'),(2,105,'ry','若依','00','ry@qq.com','15666666666','1','','8e6d98b90472783cc73c17047ddccf36','222222','0','0','127.0.0.1',NULL,NULL,'admin','2025-09-18 13:43:59','',NULL,'测试员'),(100,NULL,'abcv','abcv','00','','','0','','39236a6df8cc1238c566378cc7911198','5bfa96','0','0','',NULL,'2025-11-10 23:49:51','admin','2025-11-10 23:49:52','',NULL,NULL),(101,NULL,'kefu','kefu','00','','','0','','7ae56702d4272e545396928050971ae9','e3ef79','0','0','',NULL,'2026-09-06 20:03:50','admin','2026-09-06 20:03:50','',NULL,NULL);
...
CREATE TABLE `vpn_lines` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=14 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='VPN线路信息表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
LOCK TABLES `vpn_lines` WRITE;
/*!40000 ALTER TABLE `vpn_lines` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `vpn_lines` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `vpn_lines_config` (
  ...
  `updated_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
  PRIMARY KEY (`id`),
  KEY `idx_vpn_line_id` (`vpn_line_id`)
) ENGINE=InnoDB AUTO_INCREMENT=14 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='VPN线路配置表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
LOCK TABLES `vpn_lines_config` WRITE;
/*!40000 ALTER TABLE `vpn_lines_config` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `vpn_lines_config` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `xray_activity` (
  ...
  PRIMARY KEY (`id`),
  KEY `idx_activity_config_id` (`activity_config_id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='Xray活动表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
LOCK TABLES `xray_activity` WRITE;
/*!40000 ALTER TABLE `xray_activity` DISABLE KEYS */;
INSERT INTO `xray_activity` VALUES (1,1,998,1,'2025-10-22 15:04:00','2025-10-29 13:11:55');
/*!40000 ALTER TABLE `xray_activity` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `xray_activity_config` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='Xray活动配置表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
LOCK TABLES `xray_activity_config` WRITE;
/*!40000 ALTER TABLE `xray_activity_config` DISABLE KEYS */;
INSERT INTO `xray_activity_config` VALUES (1,1000,1,1,'2025-10-22 15:03:14','2025-10-22 15:04:00');
/*!40000 ALTER TABLE `xray_activity_config` ENABLE KEYS */;
UNLOCK TABLES;
...
) ENGINE=InnoDB AUTO_INCREMENT=13 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='Xray 活动参与者表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
LOCK TABLES `xray_activity_participants` WRITE;
/*!40000 ALTER TABLE `xray_activity_participants` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `xray_activity_participants` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `xray_distributors` (
  ...
  KEY `idx_user_id` (`user_id`),
  KEY `idx_email` (`email`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='Xray分销商表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
LOCK TABLES `xray_distributors` WRITE;
/*!40000 ALTER TABLE `xray_distributors` DISABLE KEYS */;
/*!40000 ALTER TABLE `xray_distributors` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `xray_distributors_config` (
  ...
  `updated_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='Xray 经销商配置表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
LOCK TABLES `xray_distributors_config` WRITE;
/*!40000 ALTER TABLE `xray_distributors_config` DISABLE KEYS */;
/*!40000 ALTER TABLE `xray_distributors_config` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `xray_email_verification` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=35 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='邮箱验证码表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
LOCK TABLES `xray_email_verification` WRITE;
/*!40000 ALTER TABLE `xray_email_verification` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `xray_email_verification` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `xray_inner_users` (
  ...
  `updated_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='Xray 内部用户表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
LOCK TABLES `xray_inner_users` WRITE;
/*!40000 ALTER TABLE `xray_inner_users` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `xray_inner_users` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `xray_packet` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='会员套餐表（xray_packet）';
/*!40101 SET character_set_client = @saved_cs_client */;
...
LOCK TABLES `xray_packet` WRITE;
/*!40000 ALTER TABLE `xray_packet` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `xray_packet` ENABLE KEYS */;
UNLOCK TABLES;
...
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='支付商户配置表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
LOCK TABLES `xray_payment_merchant` WRITE;
/*!40000 ALTER TABLE `xray_payment_merchant` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `xray_payment_merchant` ENABLE KEYS */;
UNLOCK TABLES;
...
LOCK TABLES `xray_payment_notify_log` WRITE;
/*!40000 ALTER TABLE `xray_payment_notify_log` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `xray_payment_notify_log` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `xray_payment_order` (
  ...
  UNIQUE KEY `uk_payment_order_submit_token` (`submit_token`),
  KEY `idx_user_id` (`user_id`),
...
LOCK TABLES `xray_payment_order` WRITE;
/*!40000 ALTER TABLE `xray_payment_order` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `xray_payment_order` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `xray_payment_submit_token` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `uk_submit_token_token` (`token`),
  KEY `idx_submit_token_user_status` (`user_id`,`status`),
  KEY `idx_submit_token_expired_at` (`expired_at`),
  KEY `idx_submit_token_order_no` (`order_no`)
...
LOCK TABLES `xray_payment_submit_token` WRITE;
/*!40000 ALTER TABLE `xray_payment_submit_token` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `xray_payment_submit_token` ENABLE KEYS */;
UNLOCK TABLES;
...
LOCK TABLES `xray_traffic_collect` WRITE;
/*!40000 ALTER TABLE `xray_traffic_collect` DISABLE KEYS */;
/*!40000 ALTER TABLE `xray_traffic_collect` ENABLE KEYS */;
UNLOCK TABLES;
...
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='Xray 用户表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
LOCK TABLES `xray_user` WRITE;
/*!40000 ALTER TABLE `xray_user` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `xray_user` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `xray_user_session` (
  ...
  KEY `idx_user_id` (`user_id`)
) ENGINE=InnoDB AUTO_INCREMENT=65 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='Xray 用户会话表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `xray_chain_proxy_config`
--
...
CREATE TABLE `xray_chain_proxy_config` (
  ...
  `active_node_id` bigint DEFAULT NULL COMMENT '当前激活的上游跳板端点ID（关联 xray_chain_proxy_node.id）',
