...
public class HttpUtils
{
    ...
    {
        return sendGet(url, null, null, headers);
    }
    ...
    public static String sendGet(String url, String param, String contentType, Map<String, String> headers)
    {
        ...
        try
        {
            ...
            in = StringUtils.isNotEmpty(contentType) ? new BufferedReader(new InputStreamReader(connection.getInputStream(), contentType))
